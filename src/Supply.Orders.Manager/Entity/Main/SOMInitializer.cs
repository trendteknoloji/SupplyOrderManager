...
{
    public class SOMInitializer<TContext, TMigrationsConfiguration> : IDatabaseInitializer<TContext>
          ...
          where TMigrationsConfiguration : DbMigrationsConfiguration<TContext>, new()
    {
        ...
        public SOMInitializer(string connectionString)
        {
            config = new TMigrationsConfiguration { TargetDatabase = new DbConnectionInfo(connectionString) };
        }
    ...
    public static class DatabaseHelper
    {
        ...
        public static bool CreateDb(string serverName, string databaseName, string userName, string password)
        {
            ...
            var db = new SOMContext();
            var dbInitializer = new SOMInitializer<SOMContext, Supply.Orders.Manager.Entity.Configuration>(builder.ConnectionString);
