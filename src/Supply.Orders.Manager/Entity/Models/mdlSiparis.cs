...
{
    [Serializable, Table("SIPARISLER"), SOM(Version = "v1.0a", Tag = "sip_")]
    public class mdlSiparis : mdlBase
    {
        [Display(Name = "Sipariş Tarih", Description = "Sipariş Tarih"), SOM("v1.0a"), DataMember]
        public DateTime tarih { get; set; }
        [Display(Name = "Sipariş Kodu", Description = "Sipariş Kodu"), SOM("v1.0a"), StringLength(50), DataMember]
        ...
        [Display(Name = "Genişlik", Description = "Genişlik"), SOM("v1.0a"), DisplayFormat(DataFormatString = "N0"), DataMember]
        public double genislik { get; set; }
        [Display(Name = "Boy", Description = "Boy"), SOM("v1.0a"), DisplayFormat(DataFormatString = "N0"), DataMember]
        public double boy { get; set; }
        [Display(Name = "Ağırlık", Description = "Ağırlık"), SOM("v1.0a"), DisplayFormat(DataFormatString = "N0"), DataMember]
